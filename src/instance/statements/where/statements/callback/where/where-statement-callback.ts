...
import {WhereNoneHaveStatementCallbackStatement} from "../where-none-have/where-none-have-statement-callback-statement";
import {WhereAllHaveStatementCallbackStatement} from "../where-all-have/where-all-have-statement-callback-statement";
...
export class WhereStatementCallback {
    ...
    public where(key: string | any , action?: string, value?: string|number): WhereStatementCallback {
        if (action) {
            ...
            this.statement.getWhereStatementController().add(new WhereStatementCallbackStatement(key, this.statement.getObject()));
        }
        return this;
    }
    ...
    public orWhere(key: string | any , action?: string, value?: string|number): WhereStatementCallback {
        if (action) {
            ...
            this.statement.getWhereStatementController().addNewBag(new WhereStatementCallbackStatement(key, this.statement.getObject()));
        }
        return this;
    }
