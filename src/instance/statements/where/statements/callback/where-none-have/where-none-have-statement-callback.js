...
const where_none_have_statement_callback_statement_1 = require("./where-none-have-statement-callback-statement");
...
class WhereNoneHaveStatementCallback {
    ...
    where(key, action, value) {
        if (action) {
            ...
            this.statement.getWhereStatementController().add(new where_none_have_statement_callback_statement_1.WhereNoneHaveStatementCallbackStatement(key, this.statement.getRelation().getRelationObject()));
        }
        return this;
    }
    orWhere(key, action, value) {
        if (action) {
            ...
            this.statement.getWhereStatementController().addNewBag(new where_none_have_statement_callback_statement_1.WhereNoneHaveStatementCallbackStatement(key, this.statement.getRelation().getRelationObject()));
        }
        return this;
    }
...
exports.WhereNoneHaveStatementCallback = WhereNoneHaveStatementCallback;
