...
const where_all_have_statement_callback_statement_1 = require("./where-all-have-statement-callback-statement");
...
class WhereAllHaveStatementCallback {
    ...
    where(key, action, value) {
        if (action) {
            ...
            this.statement.getWhereStatementController().add(new where_all_have_statement_callback_statement_1.WhereAllHaveStatementCallbackStatement(key, this.statement.getRelation().getRelationObject()));
        }
        return this;
    }
    orWhere(key, action, value) {
        if (action) {
            ...
            this.statement.getWhereStatementController().addNewBag(new where_all_have_statement_callback_statement_1.WhereAllHaveStatementCallbackStatement(key, this.statement.getRelation().getRelationObject()));
        }
        return this;
    }
...
exports.WhereAllHaveStatementCallback = WhereAllHaveStatementCallback;
